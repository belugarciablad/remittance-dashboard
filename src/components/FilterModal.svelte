        ...
        <div class="applied-filters bg-gray-100 p-4 rounded-lg shadow-md">
          ...
          <div class="flex flex-wrap gap-x-2 gap-y-4">
            <div class="text-gray-600">
              <span
                class="inline-block bg-orange-200 text-orange-800 rounded-full px-2 py-1 text-sm mr-2 mt-2"
                >{$t(getTranslationKey.dateRange(dateRangeFilter))}</span
              >
              {#each selectedPaymentMethods as paymentMethod}
                <span
                  class="inline-block bg-gray-200 text-gray-800 rounded-full px-2 py-1 text-sm mr-2 mt-2"
                >
              ...
              {#each selectedStatuses as status}
                <span
                  class="inline-block bg-blue-200 text-blue-800 rounded-full px-2 py-1 text-sm mr-2 mt-2"
                >
