            ...
            {#each availableStatuses as status}
                <label class="inline-flex items-center space-x-1">
                    <input 
                        ...
                        class="hidden peer"
                    />
                    <span class="w-24 md:w-32 h-8 text-sm border-2 border-gray-200 rounded-md flex items-center justify-center peer-checked:bg-blue-600 peer-checked:border-blue-600 peer-checked:text-white transition-colors">
                        {status}
                    </span>
                </label>
            {/each}
