export const repeatTransaction = (transaction) => {
    alert(' TO DO. Mostrar un preview de como quedaria, permitir editar los montos, y hacer una peticion al endpoint de wpp para recrear la transaccion')
}
export const downloadDetail = (transaction) => {
    try {
        ...
        alert("Hubo un error al intentar descargar el PDF. Intenta nuevamente.");
    }
}